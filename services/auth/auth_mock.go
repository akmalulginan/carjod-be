...
func (m *MockAuthUsecase) Login(ctx context.Context, data domain.Auth) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthUsecase) Register(ctx context.Context, data domain.Auth) error {
	m.ctrl.T.Helper()
